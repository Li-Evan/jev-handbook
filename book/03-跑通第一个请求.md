...
![问题先在 Playground 里调顺，接进代码时把版本写死](assets/figures/03-1.png)
...
![官方快速上手页把 Playground 的用法压成四步：贴一段文字当 state，加一个 Noul 问题，再往里加更多问题；第一步就写着要先登录。截自 docs.typesafe.ai 的快速上手页](assets/shots/03-quickstart-playground.png)
...
![从法国顺序调用同一批邮件，Jev 的中位延迟 239 毫秒、p95 331 毫秒，下面那条虚线是网络本身的下限，定超时之前得先把它扣掉。图片来自 anisselbd 的 jev-phishing-bench 仓库](assets/shots/03-bench-latency.png)
